...
install -c -m 755 -s bin/xxdiff ${RPM_BUILD_ROOT}/usr/bin/
install -c -m 644 src/xxdiff.1 ${RPM_BUILD_ROOT}/usr/share/man/man1/xxdiff.1
...
/usr/bin/xxdiff
/usr/share/man/man1/xxdiff.1*


%changelog
* Wed Apr 5 2006 Harshula <hash@jayasolutions.cjb.net>
- Forked and modified for Fedora Core 5 changes.
