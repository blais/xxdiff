...
StringToken tagList[] = {
   { "Conflict.Start", TAG_CONFLICT_START,
     "String used to indicate the start of a merged merge conflict when saving \
with conflicts. Default is the CVS start tag." },

   { "Conflict.Sep", TAG_CONFLICT_SEP,
     "String used to separate sides of a merged merge conflict when saving \
with conflicts. Default is the CVS separator tag." },

   { "Conflict.SepExtra", TAG_CONFLICT_SEP_EXTRA,
     "String used to separate sides of a merged 3-way merge conflict when \
saving with conflicts. Default is the tag generated by GNU diff3." },

   { "Conflict.End", TAG_CONFLICT_END,
     "String used to end a merged merge conflict when saving with conflicts. \
Default is the CVS end tag." },
...
sides of a merged merge conflict. Default is the CVS separator tag." },
...
diff3." },
   ...
   { "Unmerge.End", TAG_UNMERGE_END,
     "Tag that appears at the beginning of a line in a merged file to indicate \
the end of a merged merge conflict. Default is the CVS end tag." },
